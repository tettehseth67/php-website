                    ...
                    <div class="col-md-4">
                        <div class="card text-white bg-primary mb-3">
                            <div class="card-body">
                                ...
                                <a href="manage_students.php" class="btn btn-light">Go to Students</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card text-white bg-danger mb-3">
                            <div class="card-body">
                                ...
                                <a href="manage_teachers.php" class="btn btn-light">Go to Teachers</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card text-white bg-warning mb-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Assign subjects and schedules to teachers.</p>
                                <a href="manage_schedules.php" class="btn btn-light">Go to Schedules</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card text-white bg-success mb-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Add, update, or remove attendee accounts.</p>
                                <a href="manage_attendees.php" class="btn btn-light">Go to Attendees</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
